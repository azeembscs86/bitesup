      ...
      <div id="page-content-gird-old" style="display:none;">
                <section class="container">
                    <div class="">
                        ...
                        <div class="">
                            <header>
                                <h1 class="page-title">Oldest Restaurant </h1>
                            </header>
                            <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                    <a href="#" class="btn icon active" onclick="return girdsection()"><i class="fa fa-th"></i>Grid</a>
      ...
      <div id="page-content-gird-open" style="display:none;">
                <section class="container">
                    <div class="">
                        ...
                        <div class="">
                            <header>
                                <h1 class="page-title">Open Restaurant </h1>
                            </header>
                            <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                ...
                                <div class="buttons pull-left" style="margin-left: 200px;">
                                    <button class="btn icon active" onclick="return girdOpenRestaurant()"><strong>Open</strong></button>
                                    <button class="btn icon" onclick="return girdNearRestaurant()"><strong>Under 5 Miles</strong></button>
                                    <button class="btn icon" onclick="return girdDiscountRestaurant()"><strong>Discount</strong></button>
                                </div>
                                <div class="pull-right">
                        ...
                        <div class="">
                            ...
                            <figure class="filter clearfix">
                                ...
                                <div class="buttons pull-left" style="margin-left: 200px;">
                                    <button class="btn icon" onclick="return girdOpenRestaurant()"><strong>Open</strong></button>
                                    <button class="btn icon" onclick="return girdNearRestaurant()"><strong>Under 5 Miles</strong></button>
                                    <button class="btn icon active" onclick="return girdDiscountRestaurant()"><strong>Discount</strong></button>
                                </div>
                                <div class="pull-right">
                                    <aside class="sorting">
                                        <span>Sorting</span>
                    ...
                    <div class="">
                        ...
                        <div class="">
                            ...
                            <figure class="filter clearfix">
                                ...
                                <div class="buttons pull-left" style="margin-left: 200px;">
                                    <button class="btn icon" onclick="return girdOpenRestaurant()"><strong>Open</strong></button>
                                    <button class="btn icon active" onclick="return girdNearRestaurant()"><strong>Under 5 Miles</strong></button>
                                    <button class="btn icon" onclick="return girdDiscountRestaurant()"><strong>Discount</strong></button>
                                </div>
                                <div class="pull-right">
                                    <aside class="sorting">
...
if (!empty($cusine_type)) {
    ...
    <!------------- open resturant list view ---------------->  
      
      <div id="page-content1-open-restaurant" style="display:none;">
                <section class="container">
                    <div class="row">
                        <!--Content-->
                        <div class="col-md-9">
                            ...
                            <figure class="filter clearfix">
                                ...
                                <div class="buttons pull-left" style="margin-left: 97px;">
                                    <button class="btn icon active" onclick="return listOpenRestaurant()"><strong>Open</strong></button>
                                    <button class="btn icon" onclick="return listNearRestaurant()"><strong>Under 5 Miles</strong></button>
                                    <button class="btn icon" onclick="return listDiscountRestaurant()"><strong>Discount</strong></button>
                                </div>
                                <div class="pull-right">
...
if (!empty($cusine_type)) {
    ...
    <!-------------------open restaurant list view end------------------>  
      
      
    
    
    <!------------- Near resturant list view ---------------->  
      
      <div id="page-content1-near-restaurant" style="display:none;">
                <section class="container">
                    <div class="row">
                        <!--Content-->
                        <div class="col-md-9">
                            ...
                            <figure class="filter clearfix">
                                ...
                                <div class="buttons pull-left" style="margin-left: 97px;">
                                    <button class="btn icon" onclick="return listOpenRestaurant()"><strong>Open</strong></button>
                                    <button class="btn icon active" onclick="return listNearRestaurant()"><strong>Under 5 Miles</strong></button>
                                    <button class="btn icon" onclick="return listDiscountRestaurant()"><strong>Discount</strong></button>
...
if (!empty($cusine_type)) {
    ...
    <!-------------------near restaurant list view end------------------>  
    
    
      
    <!------------- Discount resturant list view ---------------->  
      
      <div id="page-content1-discount-restaurant" style="display:none;">
                <section class="container">
                    <div class="row">
                        <!--Content-->
                        <div class="col-md-9">
                            ...
                            <figure class="filter clearfix">
                                ...
                                <div class="buttons pull-left" style="margin-left: 97px;">
                                    <button class="btn icon" onclick="return listOpenRestaurant()"><strong>Open</strong></button>
                                    <button class="btn icon" onclick="return listNearRestaurant()"><strong>Under 5 Miles</strong></button>
                                    <button class="btn icon active" onclick="return listDiscountRestaurant()"><strong>Discount</strong></button>
                                </div>
                                <div class="pull-right">
                                    <aside class="sorting">
                                        <span>Sorting</span>
...
<script src="//code.jquery.com/jquery-1.10.2.min.js"></script>
 ...
 <script>
    function girdsection()
    {
          ...
          $("#page-content1-open-restaurant").hide();
          $("#page-content1-near-restaurant").hide();
          $("#page-content1-discount-restaurant").hide();
          $("#").removeClass("intro");
 ...
 {   
      $("#page-content1-open-restaurant").show();
      $("#page-content-gird-open").hide(); 
      $("#page-content-gird-discount").hide();
      $("#page-content-gird-old").hide(); 
      $("#page-content-gird-latests").hide();
 ...
 {
      $("#page-content1-near-restaurant").show();
      $("#page-content1-open-restaurant").hide();
      $("#page-content-gird-open").hide(); 
      $("#page-content-gird-discount").hide();
      $("#page-content-gird-old").hide(); 
 ...
 {
      $("#page-content1-discount-restaurant").show();
      $("#page-content1-near-restaurant").hide();
      $("#page-content1-open-restaurant").hide();
      $("#page-content-gird-open").hide(); 
      $("#page-content-gird-discount").hide();
