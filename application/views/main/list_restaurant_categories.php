                ...
                <div class="col-lg-8">
                   ...
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                  <a href="<?php echo base_url() ?>main/category_restaurant/<?php echo $category_id; ?>" class="btn icon"><i class="fa fa-th"></i>Grid</a>
                                    <a href="<?php echo base_url() ?>main/list_category_restaurant/<?php echo $category_id; ?>" class="btn icon active"><i class="fa fa-th-list"></i>List</a>
                                </div>
...
function load_contents(track_page){
	...
	$.post( '<?php echo base_url() ?>main/load_list_more_category_restaurant', {'page': track_page,'category_id' : "<?php echo $category_id; ?>"}, function(data){
