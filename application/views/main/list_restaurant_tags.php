...
$('#results').load("<?php echo base_url() ?>main/load_list_more_tags_restaurant", {'group_no':total_record}, function() {total_record++;});
$(window).scroll(function() {       
    ...
    {           
        if(total_record <= total_groups)
        {
            loading = true; 
            $('.loader_image').show(); 
            $.post('<?php echo site_url() ?>main/load_list_more_tags_restaurant',{'group_no': total_record},
            function(data){ 
                if (data != "") {                               
                    $("#results").append(data);  
                    $('.loader_image').hide();                  
