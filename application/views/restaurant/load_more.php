 ...
 <!--Sub Header-->
     ...
     <section  class="block equal-height">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <header><h2 style="margin-bottom: 95px;margin-left: 15px;">SEARCH RESULT</h2></header>
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                    <button class="btn icon active" onclick="return girdsection()"><i class="fa fa-th"></i>Grid</button>
                                    <button class="btn icon" onclick="return listsection()"><i class="fa fa-th-list"></i>List</button>
                                </div>
                                
                                <div class="buttons pull-left" style="margin-left: 35px;">
    ...
    <?php }
     ...
     <div id="page-content-gird-latests" style="display:none;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <header><h2 style="margin-bottom: 95px;margin-left: 15px;">Latest Restaurant Search Results</h2></header>
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
    ...
    <!--- old restaurant in gird------>
      <div id="page-content-gird-old" style="display:none;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <header><h2 style="margin-bottom: 95px;margin-left: 15px;">Oldest Restaurant Search Results</h2></header>
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                    <a href="#" class="btn icon active" onclick="return girdsection()"><i class="fa fa-th"></i>Grid</a>
                                    <a href="#" class="btn icon" onclick="return listsection()"><i class="fa fa-th-list"></i>List</a>
    ...
    <?php }
      ...
      <div id="page-content-gird-open" style="display:none;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <header><h2 style="margin-bottom: 95px;margin-left: 15px;">Open Restaurant Search Results</h2></header>
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                    <a href="#" class="btn icon active" onclick="return girdsection()"><i class="fa fa-th"></i>Grid</a>
                                    <a href="#" class="btn icon" onclick="return listsection()"><i class="fa fa-th-list"></i>List</a>
    ...
    <?php }
      ...
      <div id="page-content-gird-discount" style="display:none;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <header><h2 style="margin-bottom: 95px;margin-left: 15px;">Discount Restaurant Search Results</h2></header>
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                    <a href="#" class="btn icon active" onclick="return girdsection()"><i class="fa fa-th"></i>Grid</a>
                                    <a href="#" class="btn icon" onclick="return listsection()"><i class="fa fa-th-list"></i>List</a>
    ...
    <?php }
      ...
      <div id="page-content-gird-near" style="display:none;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <header><h2 style="margin-bottom: 95px;margin-left: 15px;">Near By Restaurant Search Results</h2></header>
                   <figure class="filter clearfix">
                                <div class="buttons pull-left">
                                    <a href="#" class="btn icon active" onclick="return girdsection()"><i class="fa fa-th"></i>Grid</a>
                                    <a href="#" class="btn icon" onclick="return listsection()"><i class="fa fa-th-list"></i>List</a>
