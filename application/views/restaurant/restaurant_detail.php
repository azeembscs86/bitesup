                                        ...
                                        <?php if(!empty($restaurant_tag[0]->tag)){ ?>
                                          ...
                                          <section>                                         
                                           ...
                                           <ul class="bullets">
                                               ...
                                               <li><a href="<?php echo  base_url(); ?>main/restaurant_selected_tags/<?php echo urlencode($tag->tag);  ?>"><?php echo $tag->tag; ?></a></li>
                                               <?php } ?>
                                           </ul>
                                        </section>
                                        <?php } ?> 
                                        ...
                                        if (!empty($restaurant_detail->server)) {
                                            ...
                                            <?php foreach ($all_services as $row) { ?>
                                               ...
                                               <?php if (in_array($row->id, $server)) { ?>
                                                <li><a href="<?php echo base_url(); ?>main/services_restaurant/<?php echo urlencode($row->name); ?>"><?php echo $row->name ?></a></li>
                                                    <?php    } ?>
                                                <?php } ?>
                                            </ul>
                                            </figure>  
...
//end foreach
  ...
  <div class="tab-content">
          ...
          <article class="block">
              ...
              <hr>
                                        ...
                                        <section class="block" id="reviews">
                                            ...
                                            <section class="reviews" id="user_reviews">
    ...
    float: right;"><?php echo $date; ?></div>
                                            ...
                                            <section class="reviews" id="user_reviewss">
                                        ...
                                        <section id="write-review">
                                            ...
                                            <form id="form-review" role="form" name="user_restaurant_review" method="post" action="" class="background-color-white">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <aside class="user-rating">
                                                            ...
                                                            <figure class="rating active" id="rating" data-name="value" name></figure>
                                                        </aside>
...
if ($('#user_id').val() != ''){
    ...
    var dataString = 'user_id='+ user_id + '&restaurant_id='+ restaurant_id + '&review_message='+ review_message + '&rating='+ rating;
    $.ajax({
type: "POST",
url: "<?php echo base_url(); ?>restaurant/add_user_review",
data: dataString,
cache: false,
success: function(result){
 $('#user_reviews').hide();
 $('#user_reviewss').append(result);
...
}else
{
   ...
   var url="<?php echo base_url(); ?>restaurant/restaurant_detail/<?php echo $this->uri->segment(3); ?>";
    window.location.replace("<?php echo base_url() ?>login/"+url+);
}
return false;
});
});
