...
class main extends CI_Controller {
    ...
    public function index() {        
        ...
        $data['featured_restaurant'] = $this->restaurant_model->get_featured_restaurant_location($country_id);
    ...
    public function category_restaurant()
    {
        ...
        $total_data = $this->restaurant_model->get_count_restaurant_by_cusine_type($category_id);
        $content_per_page = 9; 
...
public function load_list_more_category_restaurant()
    ...
    public function register() {
        ...
        $data['bottom_inner'] = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; 
   ...
   public function requests() {
        ...
        $data['popular_restaurant'] = $this->restaurant_model->get_papular_restaurant_location($country_id); //For Sidebar
    ...
    public function search_result() {
            ...
            $data['keyword']= $this->input->get('keyword_search');
            $data['location']= $this->input->get('search_location');
            $data['folder_name'] = 'main';
            ...
            $data['popular_restaurant'] = $this->restaurant_model->get_featured_restaurant_location($country_id);
            $data['user_reviews']= $this->restaurant_model->get_most_user_by_reviews();
