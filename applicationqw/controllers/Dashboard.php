...
//         / print_r($socials_hits);
     ...
     public function get_city_drop_down(){
	//echo "Function Exist"; exit;
        $this->load->model('cities_model');

        $get_country_id = $this->input->post('country_id', true);
	//echo $get_country_id; exit;

        $cities= $this->cities_model->get_cities_by_countries_id($get_country_id);


        $city_html = '<select id="c1" name="country" class="populate "  style="width:40%" required>';
