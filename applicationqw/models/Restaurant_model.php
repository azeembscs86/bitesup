...
class Restaurant_model extends CI_Model {
    ...
    function get_restaurants($country_id) {
    $where="restaurant.country_id=$country_id";
   ...
   function get_all_restaurant() {
    ...
    public function get_featured_restaurant_location($country_id)
    {
            $where="restaurant.country_id=$country_id";
    ...
    public function get_papular_restaurant_location($country_id)
    {
         $where="restaurant.country_id=$country_id";
    ...
    {
            $query= $this->db->select(array('username'))
                             ->from('users')
    ...
    {
        $query= $this->db->select(array('email'))
                         ->from('users')
                         ->where('email', $email)
                         ->get();
        return $result= $query->num_rows(); 
